import { throttle, Button, Image, showModal } from '@natsume_shiki/mika-ui';
import './Login.less';
import React, { useCallback, useEffect, useRef, useState } from 'react';
import { getCaptcha, isUserLoggedInSync, login } from 'services/login';
...
export const SubmitButton = () => {
  ...
  const loginCallback = useCallback(
    async (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
      ...
      return login(data).then((res: { code: number; msg: React.SetStateAction<string | null> }) => {
        setDisable(false);
